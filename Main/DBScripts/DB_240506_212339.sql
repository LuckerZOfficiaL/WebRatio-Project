...
alter table `enrolledcourse`   add index fk_enrolledcourse_course (`course_courseid`), add constraint fk_enrolledcourse_course foreign key (`course_courseid`) references `course` (`courseid`);
...
alter table `lecture`   add index fk_lecture_course (`course_courseid`), add constraint fk_lecture_course foreign key (`course_courseid`) references `course` (`courseid`);
