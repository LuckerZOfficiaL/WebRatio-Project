...
-- Student_Grades [rel1]
alter table "public"."grades"  add column  "student_oid"  int4;
alter table "public"."grades"   add constraint fk_grades_student foreign key ("student_oid") references "public"."student" ("user_oid");


-- Student_Exam [rel2]
create table "public"."student_exam" (
   "student_oid"  int4 not null,
   "exam_exam_code"  int4 not null,
  primary key ("student_oid", "exam_exam_code")
);
alter table "public"."student_exam"   add constraint fk_student_exam_student foreign key ("student_oid") references "public"."student" ("user_oid");
...
-- GEN FK: Student --> User
alter table "public"."student"   add constraint fk_student_user foreign key ("user_oid") references "public"."user" ("oid");
