...
-- Student_Grades [rel1]
alter table "public"."grades"  add column  "student_student_code"  int4;
alter table "public"."grades"   add constraint fk_grades_student foreign key ("student_student_code") references "public"."student" ("student_code");
